    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                if (result.code === "DISCORD_ONLY") {
                    setError("Akun ini terdaftar via Discord. Silakan login dengan Discord.")
                    setErrorField("email")
                    return
                }

                const errMsg = result.error || "Login gagal"
                setError(errMsg)
                    ...
                    <form onSubmit={handleSubmit}>
                        <FieldGroup>
                            ...
                            <Field>
                                ...
                                <Button variant="outline" type="button" className="w-full bg-[#5865F2] hover:bg-[#4752C4] hover:text-white text-white border-none">
